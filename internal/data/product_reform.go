...
func (v *productTableType) Columns() []string {
	return []string{"product_id", "party_id", "serial", "place", "addr", "production"}
}
...
var ProductTable = &productTableType{
	s: parse.StructInfo{Type: "Product", SQLSchema: "", SQLName: "product", Fields: []parse.FieldInfo{{Name: "ProductID", Type: "int64", Column: "product_id"}, {Name: "PartyID", Type: "int64", Column: "party_id"}, {Name: "Serial", Type: "int64", Column: "serial"}, {Name: "Place", Type: "int64", Column: "place"}, {Name: "Addr", Type: "int64", Column: "addr"}, {Name: "Production", Type: "bool", Column: "production"}}, PKFieldIndex: 0},
...
func (s Product) String() string {
	...
	res[5] = "Production: " + reform.Inspect(s.Production, true)
